...
<head>
<meta charset="utf-8" />
<title><c:out value="${applicationScope.languageManager.getLanguageValue('journal_list_of_conf_title', sessionScope.tag)}" /></title>
...
<div>
	<fieldset>
		<legend><c:out value="${applicationScope.languageManager.getLanguageValue('journal_list_conf', sessionScope.tag)}" /> </legend>
		<table border=1>
			<thead>
				<tr>
			...
			<tbody>
				<c:forEach items="${baoJournalOrConf}" var="v">
					<tr>
						...
						<td width="20%"><img src="<c:out value="${v['journalOrConfLogo']}"></c:out>" align="center" with="100" height="100"/></td>
