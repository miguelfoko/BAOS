...
<<<<<<< HEAD
					    ...
					    <ul class="dropdown-menu">
		                  ...
		                  <li><a href="<c:url value="index.jsp?m=${applicationScope.encryptor.encrypt('elearning')}" />}">Learning</a></li>
					      <li><a href="#">Conferences</a></li>
					      <li><a href="#">Books</a></li>
		        		  <li><a href="#">News</a></li>
		        		  <li><a href="#">Paper Submission</a></li>
					      <li class="divider"></li>
					      <li><a href="#">About BAOS</a></li>
					    </ul>
				  	</div>
		        </li>
		        <li class="pgb-to-hide-870"><a href="index.jsp"><span class="glyphicon glyphicon-home"></span> Home</a></li>
			    <li class="pgb-to-hide-970"><a href="#">Articles</a></li>
