...
<<<<<<< HEAD
					<legend >Author management</legend>
						<ol id="olPubli">
							...
							<li id="liPubli"><label id="labelPubli">Author Institution</label><input type="text"  name="AuthorInstitution" /></li>
							<li id="liPubli"><label id="labelPubli">Author mail</label><input type="email"  name="Authormail" /></li>
...
<<<<<<< HEAD
					<legend>Suggest reviewers (at least three)</legend>
						<ol id="olPubli">
							...
							<li id="liPubli"><label id="labelPubli">Last name</label><input type="text"  name="reviewer1LastName" /></li>
							<li id="liPubli"><label id="labelPubli">Academic degree</label><input type="email"  name="reviewer1AcademicDegree" /></li>
							<li id="liPubli"><label id="labelPubli">Institution</label><input type="email"  name="reviewer1Institution" /></li>
							<li id="liPubli"><label id="labelPubli">email</label><input type="email"  name="reviewer1Email" /></li>
							<li><input type="hidden" value="<c:out value="${applicationScope.encryptor.encrypt('publications')}"/>" id="modEncryptedName" /></li>
							<li><input type="hidden" value="<c:out value="${applicationScope.encryptor.encrypt('paperSubmission')}"/>" id="actionEncryptedName" /></li>
							<li id="liPubli"><button type=submit class="reviewerManagement">Add another reviewer</button></li> 
						</ol>
				</fieldset>
...
<<<<<<< HEAD
					...
					<ol id="olPubli">
							...
							<li id="liPubli"><label id="labelPubli">Paper title</label><textarea id="textareaPubli" name="paperTitle" rows="2" cols="80" ></textarea></li>
							<li id="liPubli"><label id="labelPubli">Abstract</label><textarea id="textareaPubli" name="abstract" rows="2" cols="80" ></textarea> </li>
							<li id="liPubli"><label id="labelPubli">Keywords</label><textarea id="textareaPubli" name="keywords" rows="2" cols="80" tabindex="40"></textarea> </li>
							<li id="liPubli"><label id="labelPubli">Paper file</label><input id="inputPubli" type="file" name="attachments" /></li>
							<li id="liPubli"><label id="labelPubli">Latex File</label><input id="inputPubli" type="file" name="latexFile" value="Upload File"/></li>
							<li id="liPubli"><label id="labelPubli">Bibliography file</label><input id="inputPubli" type="file" name="biblioFile" /></li>
							<li id="liPubli"><label id="labelPubli">other mentions</label><textarea id="textareaPubli" name="otherMentions" rows="2" cols="80" tabindex="40"></textarea></li>
...
<<<<<<< HEAD
	...
	<a href="<c:url value="index.jsp?m=${applicationScope.encryptor.encrypt('publications')}" />&action=${applicationScope.encryptor.encrypt('userDashboard')}&id_journal=<c:out value="${journalID}"/>">View my Dashboard</a>
