<div class="row">
	...
	<div class="col-md-12 text-center desc-row">
		<c:out value="${applicationScope.languageManager.getLanguageValue('auth_baos_publishing_desc', sessionScope.tag)}" escapeXml="false" />
	</div>
	<div class="col-md-12 desc-row">
		<div class="col-md-4 image-and-desc">
			<div class="col-md-4 text-center"><img src="<c:url value="/modules/controlpanel/images/easy.png" />" alt="" /></div>
		...
		<div class="col-md-4 image-and-desc">
			<div class="col-md-4 text-center"><img src="<c:url value="/modules/controlpanel/images/quality.jpg" />" alt="" /></div>
		...
		<div class="col-md-4 image-and-desc">
			<div class="col-md-4 text-center"><img src="<c:url value="/modules/controlpanel/images/tracking.png" />" alt="" /></div>
