...
public class ROPEncryptor {
	/**
	 * Forme courte de l'algorithme de cryptage par d�faut
	 */
	public static final String DEFAULT_ENCRYPTION_ALGO_SHORT = "AES";
	
	/**
	 * Forme longue de l'algorithme de cryptage par d�faut
	 */
	public static final String DEFAULT_ENCRYPTION_ALGO_LONG = "AES/CBC/PKCS5Padding";
	
	/**
	 * Cl� priv�e de cryptage (<i>ne utiliser qu'en cas de besoin r�el</i>)
	 */
